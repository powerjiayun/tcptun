...
tcptun-to-tcptun 部署里，`--tunnel-security reality` 可以包装 raw transport 上的任意隧道协议。Vision flow 是 VLESS 专用语义，所以只有 `--tunnel-protocol vless` 时才设置 `--flow xtls-rprx-vision`。
